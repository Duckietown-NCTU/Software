...
For more info on algorithm and parameters please refer to the google doc:
 https://drive.google.com/open?id=0B49dGT7ubfmSX1k5ZVN1dEU4M2M
    ...
    def generateVote(self,segment):
        ...
        if segment.color == segment.YELLOW or segment.color == segment.WHITE: # left lane is WHITE(BLUE) and YELLOW
            if (p2[0] > p1[0]): # left edge of yellow lane AND blue lane
                d_i = d_i - self.linewidth_yellow #assume blue lane width = yellow lane width
                phi_i = -phi_i
